"use client";
import { ShieldCheck, TrendingUp, DollarSign, Hospital, PartyPopper, Sprout, Lightbulb } from "lucide-react";
                                        ...
                                        <div className="flex flex-col md:flex-row gap-6">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                                                    ...
                                                    <span className="inline-block px-4 py-2 bg-[#FAEAB1]/50 text-[#334443] rounded-full text-base font-semibold">
                                                        {initiative.period}
                                                    </span>
                                                </div>
                                                ...
                                                <div className="flex items-center gap-2 p-4 bg-[#FAEAB1]/20 rounded-lg border border-[#FAEAB1]">
                                                    <span className="text-[#34656D] text-center">
        ...
        <div className="relative bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2 h-full flex flex-col border border-[#FAEAB1]/50">
            ...
            <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="mb-4 p-4 bg-gradient-to-r from-[#FAEAB1]/30 to-[#FAEAB1]/50 rounded-lg border-l-4 border-[#34656D]">
                    <p className="text-base font-semibold text-[#334443]/70 mb-1">
                        Key Impact
                    </p>
                ...
                {/* Technologies */}
                <div className="mb-4">
                    <p className="text-base text-[#334443]/60 mb-2 font-semibold">
                        Tools & Technologies:
                    </p>
                ...
                <div>
                    ...
                    <ul className="space-y-1">
                        {project.achievements.map((achievement, idx) => (
                            <li
                                key={idx}
                                className="flex items-start gap-2 text-base text-[#334443]/80"
                            >
